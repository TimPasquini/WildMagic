...
GOLDEN_BINDING_CASES = [
    {
        ...
        "claim": {"text": "There is a chapel north of town.", "tags": ["chapel"],
                  "where": "north of town", "what": "chapel", "salience": 4, "confidence": 0.7},
        "explored": [(0, 0)],
        "expected": {
    ...
    },
    {
        ...
        "claim": {"text": "Bandits have a camp east of here.", "tags": ["bandits", "camp"],
                  "where": "east", "what": "bandit camp", "salience": 4, "confidence": 0.7},
        "explored": [(0, 0)],
        "expected": {
    ...
    },
    {
        ...
        "claim": {"text": "A witch lives somewhere in the woods.", "tags": ["witch", "woods"],
                  "where": "in the woods", "what": "witch", "salience": 4, "confidence": 0.6},
        "explored": [(0, 0)],
        "expected": {
    ...
    },
    {
        ...
        "claim": {"text": "They buried the old king in a barrow, they say.", "tags": ["barrow", "tomb"],
                  "where": None, "what": "barrow", "salience": 3, "confidence": 0.5},
        "explored": [(0, 0)],
        "expected": {
            "space": {"mode": "wildcard"},
    ...
    },
    {
        ...
        "claim": {"text": "Smugglers keep a cache near the south road.", "tags": ["cache", "smugglers"],
                  "where": "south", "what": "cache", "salience": 3, "confidence": 0.6},
        "explored": [(0, 0)],
        "expected": {
            "space": {"mode": "direction", "direction": (0, 1), "anchor_zone": (0, 0)},
            "bound_zone": (0, 1),
    ...
    },
    {
        ...
        "claim": {"text": "The moon forgets this valley every third night.", "tags": ["moon", "valley"],
                  "where": None, "what": None, "salience": 2, "confidence": 0.5},
        "explored": [(0, 0)],
        "expected": None,  # no blueprint match -> flavor lore, never realizes
    },
    {
        "name": "low_confidence_stays_flavor",
        "claim": {"text": "Maybe there's a shrine north? I really couldn't say.", "tags": ["shrine"],
                  "where": "north", "what": "shrine", "salience": 2, "confidence": 0.3},
        "explored": [(0, 0)],
